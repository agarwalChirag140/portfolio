...
export const Intro = () => {
    ...
    return (
        <>
            ...
            {/* Description */}
            <p className="text-center text-lg pl-1 pr-1 w-11/12 md:w-4/5 lg:w-2/5 m-auto mt-10 ">A sincere and passionate developer with proficiency in working well with the React-Redux framework. Capable of working under pressure with ease and delivering the best in any situation. Looking forward to creating a celebrated career as a Full Stack Developer.</p>
