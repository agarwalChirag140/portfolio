...
export const Tech = () => {
    return (
        <>
            ...
            <div className="grid grid-cols-2 grid-rows-2 sm:flex m-auto sm:justify-evenly w-full sm:w-3/4 ">

                <div className="m-auto mt-2">
                    <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full p-6 bg-green-700 ">
                        <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-full bg-white flex justify-center items-center">
                            <img src={html} alt="html logo" className="w-16" />
                        </div>
                    </div>
                    <p className="text-center pt-2 text-lg">HTML5</p>
                </div>
                ...
                <div className="m-auto">
                    ...
                    <p className="text-center pt-2 text-lg">CSS3</p>
                </div>

                <div className="m-auto">
                    <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full p-6 bg-green-700 ">
                        <div className="w-20 h-20 sm:w-28 sm:h-28  rounded-full bg-white">
                            <img src={JavaScript} alt="js logo" />
                        </div>
                    </div>
                    <p className="text-center pt-2 text-lg">JAVASCRIPT</p>
                </div>
                ...
                <div className="m-auto">
                    ...
                    <p className="text-center pt-2 text-lg">REACT JS</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 grid-rows-1 sm:flex m-auto sm:justify-evenly w-full sm:w-2/5 mt-4">
                ...
                <div className="m-auto mt-2">
                    ...
                    <p className="text-center pt-2 text-lg">REDUX</p>
                </div>
                ...
                <div className="m-auto">
                    ...
                    <p className="text-center pt-2 text-lg">TAILWIND CSS</p>
                </div>
